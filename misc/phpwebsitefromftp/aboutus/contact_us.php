<?php $pageTitle = "Contact Us"; $pgNum = "1.7.0"; $pgType = "page"; include('../inc/header.inc.php'); ?>
			...
			if (isset($_POST["cSubmit"])) {
				...
				if ($errorCount > 0) {
					...
					/* 10/04/2014 per Ana's request to minimize spams
					 * Filter the message body for URL link, if found discard without sending email to DayWorker
					 */
					$result = true;
